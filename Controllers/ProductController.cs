...
namespace Cartel_Search_Products.Controllers
{
    public class ProductController : Controller
    {
        ...
        public IActionResult Browse(string search = "all", string category = "all", string sort = "default", int page = 0, int itemsPerPage = 8)
        {
            ...
            return View("BrowseProducts", paginatedProducts);
        }
    }
}
